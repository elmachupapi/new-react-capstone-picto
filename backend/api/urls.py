...
urlpatterns = [
    ...
    path("item/electronics/update", views.UpdateElectronics.as_view(), name = "item-update-janitorial"),
    path("item/itsupplies/update", views.UpdateITSupply.as_view(), name = "item--update-janitorial"),
    path("item/office/update", views.UpdateOffice.as_view(), name = "item-update-janitorial"),
    path("item/janitorial/update", views.UpdateJanitorial.as_view(), name = "item-update-janitorial"),
